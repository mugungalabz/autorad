...
function draw() {
  ...
  let randomOffset = (xx(16) / DEFAULT_SIZE) * DIM;
  ...
  if (framingShape > -1 && framingShape < 8 && bgType != "notebook") { //notebook framing ellipse
    ...
    notebookFrameEllipseMask.ellipse(DIM / 2.0 + frameOffset, DIM / 2.0 + frameOffset2, scale(1024 - 456) - frameOffset, scale(1024 - 456) - frameOffset);
...
function scale(a) { return (a / DEFAULT_SIZE) * DIM }
