f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f",
  ]
}
function draw() { }
function mouseClicked() {
  ...
  hash = testhashes[testhashIdx]
  console.log("Test Hash:" + hash);

  // hash = testhasha;
  randomSeed(hash);
  testhashIdx = (testhashIdx + 1) % testhashes.length
  ...
  if (framingShape > -1 && framingShape < 8 && bgType != "notebook") { //notebook framing ellipse
    ...
    noFill(); stroke(clrs[4]); strokeWeight(s(16));
  ...
  if (framingShape > 15 && framingShape < 26) { //default framing square
    frameShape = "square";
    noFill(); strokeWeight(s(16)); stroke(nonBGColor(4));
  ...
  if (framingShape > 74 && framingShape < 120) { //flipped framing triangle
    ...
    noFill(); strokeWeight(s(16)); stroke(clrs[4]);
  ...
  if (framingShape > 249 && bgType != "grid") { //diagonal grid flipped framing triangle
    ...
    noFill(); strokeWeight(s(16)); stroke(nonBGColor(4));
    triangle(s(128) + frameOffset, s(128) + frameOffset2, s(512) + frameOffset2, s(940) - frameOffset2, s(720) + frameOffset, s(128) + frameOffset); //draws stroke over the edge of the grid triangle
    blendMode(BLEND);
  }

  let centeredShape = xx(6);
  let xPos = s(512); let yPos = s(512);
  ...
  if (floatingShape1 > 174 && floatingShape1 < 200 && bgType != "horizon" && centeredShapeType != "horizon") { //-------venetian circle lines circle
    ...
    let lineH = radius * (-1);
    let firstlastline = 16; //TODO scale?
  ...
  if (curveType < 16) { // gradient tertiary flourish
    ...
    if (curveWiggler1 > s(170)) { curveWiggler1 = curveWiggler1 - s(100); }
    if (curveWiggler2 > s(120)) { curveWiggler2 = curveWiggler2 - s(100); }
    if (curveWiggler4 > s(170)) { curveWiggler4 = curveWiggler4 - s(100); }
    if (curveWiggler5 > s(170)) { curveWiggler5 = curveWiggler5 - s(100); }
  ...
  if (curveType > 15 && curveType < 65) {
    if (curveWiggler1 > s(170)) { curveWiggler1 -= s(100); }
    if (curveWiggler2 > s(120)) { curveWiggler2 -= s(100); }
    ...
    if (curveOffset > s(100)) { curveOffset = curveOffset / 5; }
    ...
    let flourishOffset = s(-320);
    if (curveHeightOffset < s(-300)) { curveHeightOffset = curveHeightOffset + s(300); }
  ...
  if (curveType > 64 && curveType < 128) { //default flourish
    ...
    if (curveOffset < s(64)) { curveOffset = curveOffset * (-1); }
    if (curveOffset > s(100)) { curveOffset = curveOffset / 5; }
    if (curveOffset < s(165)) { curveHeightOffset = 0 - s(xx(24)); }
    noFill(); strokeWeight(s(10)); stroke(clrs[2]);
    if (type == "dark" && clrs[2] == color('#000000')) { stroke(clrs[4]); } //low-effort failsafe for black flourishes on dark designs
    let failsafe_flourish_mover = 0;
    beginShape();
    if ((s(64) + curveOffset * 4) < 1) { failsafe_flourish_mover = s(200); }
  ...
  if (curveType > 240) { //alt flourish gradient
    ...
    if (curveOffset < s(64)) { curveOffset = curveOffset * (-1); }
    if (curveOffset > s(100)) { curveOffset = curveOffset / 5; }
    if (curveOffset < s(165)) { curveHeightOffset = xxs(24) * (-2); }
    maskCurve.noFill();
...
function sprinklesbg() {
  ...
  rect(0, 0, DIM, DIM); //low opacity bg
}
